      ...
      {showBorder && (
        ...
        >
          <div
            ...
            style={{ width: 'calc(100% - 2px)', height: 'calc(100% - 2px)', left: '50%', top: '50%', transform: 'translate(-50%, -50%)', zIndex: -1 }}
          />
        </motion.div>
      )}
      <motion.div
        className="inline-block relative text-transparent bg-clip-text"
        style={{ ...gradientStyle, backgroundPosition, WebkitBackgroundClip: 'text', zIndex: 2 }}
      >
        {children}
      </motion.div>
    </motion.div>
